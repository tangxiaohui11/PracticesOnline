...
import net.lzzy.practicesonline.activities.activities.fragments.SplashFragment;
...
public class SplashActivity extends BaseActivity implements SplashFragment.OnSplashFinishedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDown = findViewById(R.id.activity_splash_tv_cont_down);
    ...
    private void detectServerStatus(){
        try {
            AppUtils.tryConnectServer(ApiConstants.URL_APT);
        } catch (IOException e) {
            isServerOn=false;
